...
import com.app.car.domain.Passenger
import com.app.car.domain.PassengerRepository
...
class PassengerAPI(
    ...
    @GetMapping("/{id}")
    fun findPassenger(@PathVariable("id") id: Long) = passengerRepository.findById(id).orElseThrow { ResponseStatusException(HttpStatus.NOT_FOUND) }
